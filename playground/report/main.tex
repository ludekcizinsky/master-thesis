...
\usepackage{iftex}
\usepackage[margin=1in,headheight=48pt]{geometry}
...
\usepackage{amssymb}		% Extra symbols (e.g., \checkmark)
...
% Reduce vertical gap between the "Contents" heading and the ToC entries.
\makeatletter
