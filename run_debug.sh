...
bash /home/cizinsky/master-thesis/submodules/smplx/tools/run_smplx_to_smpl.sh /scratch/izar/cizinsky/thesis/input_data/test/hi4d_pair15_fight/v3_est_masks_gt_smplx_h6_rgb_smplx_band_and_apply_mask_to_renders