...
python preprocess/ait_datasets/hi4d/cameras_reformat.py --scene-root-dir $scene_root_dir 

echo "refomatting pair16 - jump"
scene_root_dir=/scratch/izar/cizinsky/ait_datasets/full/hi4d/pair16/pair16/jump16
python preprocess/ait_datasets/hi4d/cameras_reformat.py --scene-root-dir $scene_root_dir --first-frame-number 11
