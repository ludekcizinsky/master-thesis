...
# Hi4D
echo "Aligning to gt world frame: hi4d_pair15_fight"
...
echo "Aligning to gt world frame: hi4d_pair16_jump"
...
echo "Aligning to gt world frame: hi4d_pair17_dance"
...
echo "Aligning to gt world frame: hi4d_pair19_piggyback"
