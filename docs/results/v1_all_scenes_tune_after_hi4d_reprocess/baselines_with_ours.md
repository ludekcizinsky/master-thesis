...
We assess human pose estimation using four metrics: MPJPE [mm], MVE [mm], Contact Distance (CD) [mm], and Percentage of Correct Depth Relations (PCDR) with a threshold of 0.15m. We highlight the best results for each dataset and metric in **bold**.
...
| MultiPly | **69.4** | 83.6 | 218.4 | **0.709** |
| Ours | 93.9 | **77.7** | **195.8** | 0.647 |
