...
The experiment and training code used in this thesis is available at \url{https://github.com/ludekcizinsky/master-thesis}.

\section{More Qualitative Results}

In this section, we provide additional qualitative results to supplement the main paper. First, we show more free view point rendering results on Hi4D in Figure~\ref{fig:appendix_free_render_pair17}. 
Second, we also include scene with four people to show the scalability of our method in Figure~\ref{fig:appendix_free_render_mmm_dance}.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/appendix_free_view_render_pair17.drawio.png}
    \caption{\textbf{Free View Point Rendering of Pair 17 from Hi4d}. We show 4D reconstruction capability of our method by rendering the reconstructed humans from novel viewpoints across different time instances.}
    \label{fig:appendix_free_render_pair17}  
\end{figure}

 
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/appendix_free_view_render_mmm_dance.drawio.png}
    \caption{\textbf{Free View Point Rendering of a Scene with Four People from MMM}. We show 4D reconstruction capability of our method by rendering the reconstructed humans from novel viewpoints across different time instances.}
    \label{fig:appendix_free_render_mmm_dance}  
\end{figure}
