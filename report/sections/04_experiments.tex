...
\begin{figure}[!ht]
    ...
    \caption{\textbf{Qualitative reconstruction comparison}. We show qualitative comparison to the relevant baselines on chosen scenes from Hi4D.}
...
\begin{figure}[!ht]
    ...
    \caption{\textbf{Qualitative pose estimation comparison}. We show qualitative comparison to the relevant baselines on chosen scenes from Hi4D.}
...
\begin{figure}[!ht]
    ...
    \caption{\textbf{Qualitative instance segmentation comparison}. We show qualitative comparison to the relevant baselines on chosen scenes from Hi4D.}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/qual_difix_comp.drawio.png}
    \caption{\textbf{Qualitative comparison of novel training view synthesis}. We show comparison of novel view synthesis strategies along the following axis: (i) LHM initialization vs. random initialization, and (ii) DiFix refinement using source view vs. previous view.}
...
\begin{table}[!ht]
  ...
  \begin{tabular}{c
    ...
    \bottomrule
  \end{tabular}
  \caption{\textbf{Ablation study on novel view synthesis.} Results will be reported under the same evaluation protocol as Table~\ref{tab:nvs_results_hi4d}. $\checkmark$ enabled, $\times$ disabled. Best results are in bold.}
