...
The most promising improvements are to (i) add pose refinement (e.g., 2D keypoint-guided refinement and/or joint optimization of pose during training) to reduce systematic pose errors, (ii) improve initialization robustness (e.g., selecting initialization frames with better visibility and merging multiple candidates), and (iii) use geometry-aware regularization or alternative extraction procedures to obtain more reliable meshes from the learned Gaussians. These changes aim to preserve the practical runtime of the pipeline while improving geometric fidelity in interaction-heavy scenes.
